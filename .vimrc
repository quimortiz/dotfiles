...
map <C-P> :Files<CR>
map <C-E>  :Buffers<CR>
map <F1> :let $VIM_DIR=expand('%:p:h')<CR>:terminal<CR>cd $VIM_DIR<CR>
...
let g:languagetool_jar="/home/quim/LanguageTool-5.3/languagetool-commandline.jar"
